...
void writePersistentData() {
    ...
    std::string logMsg;
    {
        ...
        std::vector<uint8_t> encryptedAcc{ cipher.encrypt(std::vector<uint8_t>(accountsPlain.begin(), accountsPlain.end())) };
        ...
        std::vector<uint8_t> encryptedTrades{ cipher.encrypt(std::vector<uint8_t>(tradesPlain.begin(), tradesPlain.end())) };
        ...
        std::vector<uint8_t> encryptedOrders{ cipher.encrypt(std::vector<uint8_t>(ordersPlain.begin(), ordersPlain.end())) };
        ...
        std::vector<uint8_t> encryptedHistory{ cipher.encrypt(std::vector<uint8_t>(historyPlain.begin(), historyPlain.end())) };
